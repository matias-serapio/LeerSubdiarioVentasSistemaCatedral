...
public class Main {
	public static void main(String[] args) {
		...
		readAndFilterSubdiario(filePath);
	}

	public static void readAndFilterSubdiario(String filePath) {
		...
		try (FileInputStream fis = new FileInputStream(filePath); Workbook workbook = new XSSFWorkbook(fis)) {
			...
			String formattedOpRi21 = String.format("%.2f",
					...
					.replace(".", ",");
			String formattedOpCfMonExentos21 = String.format("%.2f",
					totalFacturaZ_A_Positivos_Monotributistas21 + totalFacturaZ_B_Positivos_Monotributistas21
							+ totalFacturaZ_B_Positivos_ConsumidoresFinales21
							+ totalFacturaZ_A_Positivos_ExentosNoAlcanzados21
							+ totalFacturaZ_B_Positivos_ExentosNoAlcanzados21 + totalFacturaAMonotributistaPositivos21
							+ totalFacturaAExentosNoAlcanzadosPositivos21 + totalFacturaBConsumidorFinalPositivos21
							+ totalFacturaBMonotributistaPositivos21 + totalFacturaBExentosNoAlcanzadosPositivos21)
					.replace(".", ",");
			...
			String formattedOpCfMonExentosIva21 = String.format("%.2f",
					totalFacturaZ_A_Positivos_MonotributistasIva21 + totalFacturaZ_B_Positivos_MonotributistasIva21
							+ totalFacturaZ_B_Positivos_ConsumidoresFinalesIva21
							+ totalFacturaZ_A_Positivos_ExentosNoAlcanzadosIva21
							+ totalFacturaZ_B_Positivos_ExentosNoAlcanzadosIva21
							+ totalFacturaAMonotributistaPositivosIva21 + totalFacturaAExentosNoAlcanzadosPositivosIva21
							+ totalFacturaBConsumidorFinalPositivosIva21 + totalFacturaBMonotributistaPositivosIva21
			...
			System.out.println("Operaciones con CF, MON y EXENTOS NO ALCANZADOS 21: " + formattedOpCfMonExentos21
					+ " \tIVA\t " + formattedOpCfMonExentosIva21);
			...
			String formattedOpRi10_5 = String.format("%.2f",
					...
					.replace(".", ",");
			String formattedOpCfMonExentos10_5 = String.format("%.2f", totalFacturaZ_A_Positivos_Monotributistas10_5
					+ totalFacturaZ_B_Positivos_Monotributistas10_5 + totalFacturaZ_B_Positivos_ConsumidoresFinales10_5
					+ totalFacturaZ_A_Positivos_ExentosNoAlcanzados10_5
					+ totalFacturaZ_B_Positivos_ExentosNoAlcanzados10_5 + totalFacturaAMonotributistaPositivos10_5
					+ totalFacturaAExentosNoAlcanzadosPositivos10_5 + totalFacturaBConsumidorFinalPositivos10_5
					+ totalFacturaBMonotributistaPositivos10_5 + totalFacturaBExentosNoAlcanzadosPositivos10_5)
					.replace(".", ",");
			...
			String formattedOpCfMonExentosIva10_5 = String.format("%.2f",
					totalFacturaZ_A_Positivos_MonotributistasIva10_5 + totalFacturaZ_B_Positivos_MonotributistasIva10_5
							...
							+ totalFacturaAMonotributistaPositivosIva10_5
							+ totalFacturaAExentosNoAlcanzadosPositivosIva10_5
							+ totalFacturaBConsumidorFinalPositivosIva10_5 + totalFacturaBMonotributistaPositivosIva10_5
							+ totalFacturaBExentosNoAlcanzadosPositivosIva10_5)
					.replace(".", ",");
			...
			System.out.println("Operaciones con CF, MON y EXENTOS NO ALCANZADOS 10,5: " + formattedOpCfMonExentos10_5
					+ " \tIVA\t " + formattedOpCfMonExentosIva10_5);
			...
			String formattedOpRi27 = String.format("%.2f",
					...
					.replace(".", ",");
			String formattedOpCfMonExentos27 = String.format("%.2f",
					totalFacturaZ_A_Positivos_Monotributistas27 + totalFacturaZ_B_Positivos_Monotributistas27
							+ totalFacturaZ_B_Positivos_ConsumidoresFinales27
							+ totalFacturaZ_A_Positivos_ExentosNoAlcanzados27
							+ totalFacturaZ_B_Positivos_ExentosNoAlcanzados27 + totalFacturaAMonotributistaPositivos27
							+ totalFacturaAExentosNoAlcanzadosPositivos27 + totalFacturaBConsumidorFinalPositivos27
							+ totalFacturaBMonotributistaPositivos27 + totalFacturaBExentosNoAlcanzadosPositivos27)
					.replace(".", ",");
			...
			String formattedOpCfMonExentosIva27 = String.format("%.2f",
					totalFacturaZ_A_Positivos_MonotributistasIva27 + totalFacturaZ_B_Positivos_MonotributistasIva27
							+ totalFacturaZ_B_Positivos_ConsumidoresFinalesIva27
							+ totalFacturaZ_A_Positivos_ExentosNoAlcanzadosIva27
							+ totalFacturaZ_B_Positivos_ExentosNoAlcanzadosIva27
							+ totalFacturaAMonotributistaPositivosIva27 + totalFacturaAExentosNoAlcanzadosPositivosIva27
							+ totalFacturaBConsumidorFinalPositivosIva27 + totalFacturaBMonotributistaPositivosIva27
